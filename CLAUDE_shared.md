# CLAUDE_shared.md — Moderation Ruleset (Shared Base)
# Applies to: Forum Agent (Carmen) + Chat Agent (Nathalie)
...
| Chat-OP (Volunteer) | Chat rooms | Yes — with exceptions |
...
## 2. Warning Catalogue (Shared Categories)
...
| Critical | Real incest, financial interest, FinDom → immediate permanent ban |
...
- FinDom | Findom/Sugar Relationship
  → Immediate permanent ban, no further action required

---

## 5. Shared Edge Case Rulings
...
### Ruling 4 — Discrimination vs. Hate Speech
...
### Ruling 5 — Inzest-Fantasien vs. Kriminelle Handlungen Fantasie
...
- Step-relatives (Stiefmutter, Stiefvater, Stiefschwester, Stiefbruder)
  — not blood relatives under § 173 StGB
...
## 6. Critical Safety Cases — Human Review Required (preliminary)

The following cases require immediate human review. No automated warning.
Output: HUMAN REVIEW REQUIRED

⚠️ Threats of self-harm or suicide
⚠️ Threats of violence against others (bomb threats, death threats)

Note: Exact handling (warning + report vs. report only) to be defined
after Volunteer Test feedback. Platform-specific rules may apply.

---

## 7. Missing Context Rules
